...
export const MResearchResultForm = ({ register, errors, trigger, control, nextStep }) => {
	//#region Data
	//#endregion
	...
	return (
		<div>
			<h4 className='text-center w-100'>Kết quả nghiên cứu</h4>
