...
export const MReseachDescriptionForm = ({ register, errors, trigger, previousStep, nextStep }) => {
	//#region Data
	...
	return (
		<div>
			<h4 className='text-center w-100'>Mô tả nghiên cứu</h4>
...
MReseachDescriptionForm.propTypes = {
