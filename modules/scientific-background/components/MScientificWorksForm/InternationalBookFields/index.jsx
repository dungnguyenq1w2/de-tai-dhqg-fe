		...
		<>
				...
				<div key={item.id} className='position-relative'>
					...
					<Row>
						<Col lg={6}>
							<CTextInput
								label='Tên sách'
								name={`scientific_work.international_books.${index}.name`}
								control={control}
								errors={errors}
							/>
						</Col>
						<Col>
							<CTextInput
								...
								name={`scientific_work.international_books.${index}.subject_code`}
								type='product_code'
								control={control}
								errors={errors}
							/>
					...
					<Row>
						<Col sm={6} lg={3}>
							<CTextInput
								label='Nhà xuất bản'
								name={`scientific_work.international_books.${index}.publisher`}
								control={control}
								errors={errors}
							/>
						</Col>
						<Col sm={6} lg={3}>
							<CDatePicker
								label='Năm xuất bản'
								name={`scientific_work.international_books.${index}.published_year`}
								control={control}
								errors={errors}
							/>
						</Col>
						<Col sm={6} lg={3}>
							<CSelect
								...
								name={`scientific_work.international_books.${index}.role`}
								options={[
						...
						<Col sm={6} lg={3}>
							<CTextInput
								label='Bút danh'
								name={`scientific_work.international_books.${index}.pen_name`}
								control={control}
								errors={errors}
							/>
						</Col>
			...
			<div className='d-flex justify-content-center'>
				<OverlayTrigger
					key='top'
					placement='top'
					overlay={<Tooltip id='tooltip-top'>Thêm sách xuất bản Quốc tế</Tooltip>}
				>
					<i
						type='button'
						onClick={() => {
